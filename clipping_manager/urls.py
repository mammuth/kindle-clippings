...
from clipping_manager.views import UploadMyClippingsFileView, RandomClippingView, RandomClippingFullscreenView, \
    ...
    WeeklyEmailDeliveryView, ClippingsBrowseView, UploadTextFileClippingsView, PersonalStatisticsView, ClippingsGalleryListView

urlpatterns = [
    url(r'^$', login_required(DashboardView.as_view()), name='dashboard'),
    url(r'^browse/$', login_required(ClippingsBrowseView.as_view()), name='browse'),
    url(r'^books/$', login_required(ClippingsGalleryListView.as_view()), name='books'),
